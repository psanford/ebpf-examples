...
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc $BPF_CLANG -cflags $BPF_CFLAGS bpf file_open.bpf.c -- -I../headers
...
func main() {
	...
	kp, err := link.Kprobe("security_file_open", objs.KprobeSecurityFileOpen)
	if err != nil {
